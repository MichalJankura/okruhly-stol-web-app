...
const Gallery = () => {
  return (
    <div id="gallery" className="min-h-screen relative bg-cover bg-center py-1">
      <div className="absolute inset-0"></div>
      <div className="w-full px-0 relative z-10">
        <div className="mx-auto max-w-4xl text-center mb-1 pb-10">
          <p className="mt-2 text-5xl font-semibold tracking-wide text-black sm:text-6xl">
            Galéria
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mx-0">
